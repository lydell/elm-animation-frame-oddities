...
var $author$project$AnimationButton$Idle = {$: 'Idle'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$AnimationButton$init = function (_v0) {
	return _Utils_Tuple2($author$project$AnimationButton$Idle, $elm$core$Platform$Cmd$none);
};
var $author$project$AnimationButton$Increment = {$: 'Increment'};
...
var $author$project$AnimationButton$subscriptions = function (model) {
	if (model.$ === 'Idle') {
...
var $author$project$AnimationButton$view = function (model) {
	if (model.$ === 'Idle') {
		return A2(
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$AnimationButton$Start)
				]),
			_List_fromArray(
				[
...
var $author$project$AnimationButton$main = $elm$browser$Browser$element(
	{init: $author$project$AnimationButton$init, subscriptions: $author$project$AnimationButton$subscriptions, update: $author$project$AnimationButton$update, view: $author$project$AnimationButton$view});
_Platform_export({'AnimationButton':{'init':$author$project$AnimationButton$main(
